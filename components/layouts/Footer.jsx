...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-gold-300/10 bg-soot-950 text-sand-100">
      ...
      <div className="relative mx-auto max-w-330 px-4 pt-20 pb-12 text-center sm:px-6 lg:px-8">
        <p className="font-heading text-[1.8rem] leading-[1.22] text-gold-300/70 sm:text-[2.4rem] lg:text-[3rem]">
          {siteContent.bookProfile.blurb}
        </p>
      </div>

      <div className="mx-auto h-px w-full max-w-330 px-4 sm:px-6 lg:px-8">
        <div className="h-full bg-linear-to-r from-transparent via-gold-300/25 to-transparent" />
      </div>

      <div className="relative mx-auto grid w-full max-w-330 gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.3fr_0.7fr] lg:px-8">
      ...
      <div className="border-t border-gold-300/8">
        <div className="mx-auto flex w-full max-w-330 flex-col gap-3 px-4 py-4 text-xs uppercase tracking-[0.14em] text-sand-100/35 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
