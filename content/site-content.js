export const siteContent = {
    ...
    methods: [
      {
        kind: "email",
        label: "Primary email",
        value: "Add publishing or author email before launch",
        href: null,
        placeholder: true,
      },
      {
  ...
  home: {
    ...
    bookIntro: {
      ...
      action: {
        label: "See the full book overview",
        href: "/book",
      },
    },
    testimonialHeading: {
...
export function buildMetadata(pageKey) {
  ...
  return {
    ...
    twitter: {
      ...
      title: page.title,
      description: page.description,
      images: [siteContent.assets.cover.src],
    },
  };
}
